...
app.post("/ai", async (req, res) => {
  try {
    ...
    while (interaction.status === "requires_action") {
      ...
      const args = functionCall.arguments as Record<string, any>;
      ...
      console.log("Sending tool result to Gemini:", toolResult);
      ...
      console.log("Next Gemini status:", interaction.status);
    }

    // IMPORTANT:
    // This must be OUTSIDE the while loop.
    console.log("Gemini completed:", interaction.output_text);
