    ...
    async function onGenerate() {
      ...
      try {
        ...
        if (aiData.success && aiData.output) {
          const match = aiData.output.match(
            /https:\/\/[^\s]+\.e2b\.app/
          );
        ...
        <div className="relative flex-1 h-full overflow-hidden">
          ...
          {!previewUrl && (
            <main className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
              ...
              {/* Prompt */}
              <div className="w-full max-w-2xl bg-[#120d1d]/80 backdrop-blur-xl border border-purple-500/20 rounded-xl p-3 shadow-[0_0_50px_-12px_rgba(168,85,247,0.25)]">
                ...
                <div className="flex justify-between items-center pt-2 border-t border-white/5 mt-2">
                  ...
                  <button
                    className="bg-purple-600 hover:bg-purple-500 text-white text-xs font-medium px-4 py-1.5 rounded-lg transition"
                    onClick={onGenerate}
                  >
                    Generate
                  </button>
          ...
          {previewUrl && (
            <div className="relative z-10 flex flex-col h-full p-4">
              ...
              {/* Preview Header */}
              <div className="h-10 shrink-0 flex items-center justify-between px-3 border border-white/10 border-b-0 rounded-t-xl bg-[#0c0914]">
              ...
              {/* Website */}
              <div className="flex-1 overflow-hidden border border-white/10 rounded-b-xl bg-white">
              ...
              <div className="mt-3 shrink-0">
                ...
                <div className="w-full bg-[#120d1d]/90 backdrop-blur-xl border border-purple-500/20 rounded-xl p-3">
